...
class BorrowersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create borrower" do
    assert_difference('Borrower.count') do
      post borrowers_url, params: { borrower: { email: @borrower.email, first_name: @borrower.first_name, last_name: @borrower.last_name } }
    end
  ...
  test "should update borrower" do
    patch borrower_url(@borrower), params: { borrower: { email: @borrower.email, first_name: @borrower.first_name, last_name: @borrower.last_name } }
